...
class AstarFitnessAnalyser(DataLoader):
    ...
    def print_fitness_per_tra(self, name_to_save, path_to_save):
        ...
        df.to_hdf("{}/{}".format(path_to_save, name_to_save), key='data', mode='w')
...
if __name__ == '__main__':
    ...
    a.print_graphs(name_to_read="normal_astar_attraction", path_to_read="/Users/alessandrozonta/PycharmProjects/astar/output/")
